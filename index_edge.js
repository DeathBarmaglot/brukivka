    ...
    timelines: {
        "Default Timeline": {
            ...
            timeline: [
                ...
                { id: "eid110", tween: [ "transform", "${__53}", "scaleX", '0', { fromValue: '0.09'}], position: 11572, duration: 689, easing: "easeInOutCubic" },
                { id: "eid116", tween: [ "transform", "${__53}", "scaleX", '0.09', { fromValue: '0'}], position: 12322, duration: 689, easing: "easeInOutCubic" },
                { id: "eid111", tween: [ "transform", "${__53}", "scaleY", '0', { fromValue: '0.09'}], position: 11572, duration: 689, easing: "easeInOutCubic" },
                { id: "eid117", tween: [ "transform", "${__53}", "scaleY", '0.09', { fromValue: '0'}], position: 12322, duration: 689, easing: "easeInOutCubic" },
                ...
                { id: "eid90", tween: [ "style", "${__53}", "top", '-441px', { fromValue: '-479px'}], position: 4142, duration: 304 },
                { id: "eid109", tween: [ "style", "${__53}", "top", '-383px', { fromValue: '-441px'}], position: 12322, duration: 689, easing: "easeInOutCubic" },
                { id: "eid91", tween: [ "style", "${__53}", "left", '-3330px', { fromValue: '-3341px'}], position: 4142, duration: 304 },
                { id: "eid108", tween: [ "style", "${__53}", "left", '-3369px', { fromValue: '-3330px'}], position: 12322, duration: 689, easing: "easeInOutCubic" },
                ...
                { id: "eid65", tween: [ "style", "${__53}", "background-position", [0,0], { valueTemplate: '@@0@@px @@1@@px', fromValue: [0,1200]}], position: 12322, duration: 689, easing: "easeInOutCubic" },
